...
function __wbg_adapter_28(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h88615d127def04aa(arg0, arg1, addHeapObject(arg2));
}
...
*/
module.exports.init_noah = function() {
...
* @returns {string}
*/
module.exports.get_priv_key_hex_str_by_mnemonic = function(phrase, num) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {string}
*/
module.exports.get_priv_key_str_old = function(key_pair) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(key_pair, XfrKeyPair);
...
* @returns {XfrKeyPair}
*/
module.exports.restore_keypair_from_mnemonic_secp256k1 = function(phrase) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(phrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.restore_keypair_from_mnemonic_secp256k1(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
...
function __wbg_adapter_245(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h4aeacebc5ae0a1a7(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
    ...
    */
    add_input(abar, memo, keypair, mt_leaf_info) {
        try {
            ...
            _assertClass(keypair, XfrKeyPair);
            _assertClass(mt_leaf_info, MTLeafInfo);
            var ptr0 = mt_leaf_info.__destroy_into_raw();
...
class AxfrOwnerMemoInfo {
    ...
    */
    get amount() {
        const ret = wasm.axfrownermemoinfo_amount(this.ptr);
        return BigInt.asUintN(64, ret);
    }
    /**
    * @returns {string}
...
module.exports.Ed25519Point = Ed25519Point;
/**
...
module.exports.Ed25519Scalar = Ed25519Scalar;
/**
*/
class FeeInputs {
    ...
    */
    add_operation_bar_to_abar(seed, auth_key_pair, abar_pubkey, txo_sid, input_record, owner_memo) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            _assertClass(auth_key_pair, XfrKeyPair);
            _assertClass(abar_pubkey, XfrPublicKey);
    ...
    */
    add_operation_abar_to_bar(input, owner_memo, mt_leaf_info, from_keypair, recipient, conf_amount, conf_type) {
        try {
            ...
            var ptr1 = owner_memo.__destroy_into_raw();
            _assertClass(mt_leaf_info, MTLeafInfo);
            var ptr2 = mt_leaf_info.__destroy_into_raw();
            _assertClass(from_keypair, XfrKeyPair);
            _assertClass(recipient, XfrPublicKey);
    ...
    */
    add_operation_anon_transfer(input, owner_memo, mt_leaf_info, from_keypair, to_pub_key, to_amount) {
        try {
            ...
            var ptr2 = mt_leaf_info.__destroy_into_raw();
            _assertClass(from_keypair, XfrKeyPair);
            _assertClass(to_pub_key, XfrPublicKey);
...
module.exports.ZorroFq = ZorroFq;
/**
...
module.exports.ZorroG1 = ZorroG1;
/**
...
module.exports.ZorroScalar = ZorroScalar;
...
module.exports.__wbg_instanceof_Instance_f25d9939a09a738e = function(arg0) {
    let result;
    try {
...
module.exports.__wbindgen_closure_wrapper7558 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 1786, __wbg_adapter_28);
    return addHeapObject(ret);
};
