...
export function signaturerules_new(a: number, b: number, c: number, d: number): void;
...
export function transactionbuilder_add_basic_issue_asset(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
...
export function transactionbuilder_get_randomizers(a: number): number;
export function transactionbuilder_add_operation_anon_transfer(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number): void;
export function transactionbuilder_add_operation_delegate(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function transactionbuilder_add_operation_undelegate(a: number, b: number, c: number): void;
export function transactionbuilder_add_operation_undelegate_partially(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function transactionbuilder_add_operation_claim(a: number, b: number, c: number): void;
export function transactionbuilder_add_operation_claim_custom(a: number, b: number, c: number, d: number, e: number): void;
export function transactionbuilder_add_operation_convert_account(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
...
export function anonkeys_axfr_secret_key(a: number, b: number): void;
export function anonkeys_set_axfr_secret_key(a: number, b: number, c: number): void;
export function anonkeys_axfr_public_key(a: number, b: number): void;
export function anonkeys_set_axfr_public_key(a: number, b: number, c: number): void;
export function anonkeys_enc_key(a: number, b: number): void;
export function anonkeys_set_enc_key(a: number, b: number, c: number): void;
export function anonkeys_dec_key(a: number, b: number): void;
export function anonkeys_set_dec_key(a: number, b: number, c: number): void;
export function gen_anon_keys(a: number): void;
export function get_anon_balance(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function __wbg_transferoperationbuilder_free(a: number): void;
export function transferoperationbuilder_new(): number;
export function transferoperationbuilder_add_input_with_tracing(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function transferoperationbuilder_add_input_no_tracing(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): void;
export function transferoperationbuilder_add_output_with_tracing(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number): void;
export function transferoperationbuilder_add_output_no_tracing(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
...
export function anontransferoperationbuilder_add_input(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function anontransferoperationbuilder_add_output(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function anontransferoperationbuilder_get_randomizers(a: number): number;
export function anontransferoperationbuilder_create(a: number, b: number): void;
...
export function axfr_pubkey_from_string(a: number, b: number, c: number): void;
export function randomize_axfr_pubkey(a: number, b: number, c: number, d: number): void;
export function axfr_keypair_from_string(a: number, b: number, c: number): void;
...
export function __wbg_anonblindassetrecord_free(a: number): void;
export function __wbg_get_anonblindassetrecord_amount_type_commitment(a: number): number;
export function __wbg_set_anonblindassetrecord_amount_type_commitment(a: number, b: number): void;
export function __wbg_get_anonblindassetrecord_public_key(a: number): number;
export function __wbg_set_anonblindassetrecord_public_key(a: number, b: number): void;
