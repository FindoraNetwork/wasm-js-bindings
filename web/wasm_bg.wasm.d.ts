...
export function gen_nullifier_hash(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function anontransferoperationbuilder_add_output(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
...
export function __wbg_get_anonblindassetrecord_commitment(a: number): number;
export function __wbg_set_anonblindassetrecord_commitment(a: number, b: number): void;
