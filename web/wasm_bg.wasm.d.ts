...
export function transactionbuilder_add_operation_anon_fee(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function get_open_abar(a: number, b: number, c: number, d: number, e: number): number;
export function gen_nullifier_hash(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
...
export function anontransferoperationbuilder_add_input(a: number, b: number, c: number, d: number, e: number, f: number): number;
export function anontransferoperationbuilder_add_output(a: number, b: number, c: number, d: number, e: number): number;
export function anontransferoperationbuilder_get_expected_fee(a: number, b: number): void;
export function anontransferoperationbuilder_set_fra_remainder_receiver(a: number, b: number): number;
export function anontransferoperationbuilder_get_randomizers(a: number): number;
export function anontransferoperationbuilder_get_randomizer_map(a: number): number;
export function anontransferoperationbuilder_build_and_sign(a: number): number;
...
export function randomize_axfr_pubkey(a: number, b: number, c: number): number;
export function randomize_axfr_keypair(a: number, b: number, c: number): number;
