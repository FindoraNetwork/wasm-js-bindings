...
* @returns {string}
*/
export function public_key_to_human(key: XfrPublicKey): string;
/**
...
* @returns {XfrKeyPair}
*/
export function create_keypair_from_secret_secp256k1(sk_str: string): XfrKeyPair;
/**
* @param {XfrKeyPair} kp
* @returns {XfrPublicKey}
*/
...
export interface InitOutput {
  ...
  readonly public_key_to_human: (a: number, b: number) => void;
  ...
  readonly create_keypair_from_secret_secp256k1: (a: number, b: number) => number;
