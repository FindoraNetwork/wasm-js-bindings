...
export function balance_from_account_to_utxo_by_xfr(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function balance_from_account_to_utxo_by_eth(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): void;
