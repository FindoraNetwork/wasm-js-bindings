...
* @returns {string}
*/
export function balance_from_account_to_utxo_by_xfr(amount, address, kp, nonce) {
    try {
...
* @returns {string}
*/
export function balance_from_account_to_utxo_by_eth(amount, address, kp_phrase, nonce) {
    try {
        uint64CvtShim[0] = amount;
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
...
async function init(input) {
    ...
    imports.wbg.__wbg_newwithlength_02a009c0728d3ba1 = function(arg0) {
