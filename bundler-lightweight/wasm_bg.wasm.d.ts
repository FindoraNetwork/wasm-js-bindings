...
export function restore_keypair_from_mnemonic_ed25519(a: number, b: number): number;
...
export function czk_get_asset_code(a: number): void;
export function czk_get_minimal_fee(a: number): void;
export function czk_get_minimal_fee_for_bar_to_abar(a: number): void;
export function czk_get_dest_pubkey(): number;
